...
public class MatchMain {
	...
	public static void main(String[] args) {
		...
		if(x==3)
		{
			MatchTest P = new MatchTest();
			  
			  System.out.println("Enter the Current score: ");
			  int currentscore= sc.nextInt();
			  P.setCurrentscore(currentscore);
			  System.out.println("Enter the Current over: ");
			  int curentover= sc.nextInt();
			  P.setCurentover(curentover);
			  System.out.println("Enter the Target ");
			  int target= sc.nextInt();
			  P.setTarget(target);
			  
			  float reqRunrate= P.calculateRunrate();
			  int balls= P.calculateBalls();
			  
			  P.calculateRunrate();
			  P.calculateBalls();
			  P.display(reqRunrate, balls);
		}
